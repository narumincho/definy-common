...
ideaSnapshotAndIdToJsonValue ideaSnapshotAndId =
    Je.object
        [ ( "ideaId", ideaIdToJsonValue ideaSnapshotAndId.ideaId )
        , ( "idea", ideaToJsonValue ideaSnapshotAndId.idea )
        ]
...
ideaSnapshotAndIdJsonDecoder =
    Jd.succeed
        ...
        |> Jdp.required "idea" ideaJsonDecoder
